...
namespace TopoR_PCB_Classes
{
	...
	Layers::Layer::Layer(const std::wstring &name, layer_type type, Bool compsOutline, float thickness)
	{
		_name = name;
		_type = type;
	...
	std::wstring Layers::Layer::ToString()
	{
		return _name;
	}
	...
	bool Layers::LayerStackUpContains(std::shared_ptr<LayerRef> lref)
	{
	...
	bool Layers::LayerUnStackContain(std::shared_ptr<LayerRef> lref)
	{
