...
void Constructive::BoardOutline::Shape_Contour::Shift(float x, float y) {
    //    if ((dynamic_cast<IBaseFigure*>(_NonfilledFigure)) != nullptr) {
    //        (dynamic_cast<IBaseFigure*>(_NonfilledFigure))->Shift(x, y);
    //    }
}
...
void Constructive::BoardOutline::Shape_Contour::UnitsConvert(dist_ in_units, dist_ out_units) {
    ...
    //    if ((dynamic_cast<IBaseFigure*>(_NonfilledFigure)) != nullptr) {
    //        (dynamic_cast<IBaseFigure*>(_NonfilledFigure))->UnitsConvert(in_units, out_units);
    //    }
}

void Constructive::BoardOutline::Shape_Voids::Shift(float x, float y) {
    //    if ((dynamic_cast<IBaseFigure*>(_FilledFigure)) != nullptr) {
    //        (dynamic_cast<IBaseFigure*>(_FilledFigure))->Shift(x, y);
    //    }
}
...
void Constructive::BoardOutline::Shape_Voids::UnitsConvert(dist_ in_units, dist_ out_units) {
    _lineWidth = Ut::UnitsConvert(_lineWidth, in_units, out_units);
    //    if ((dynamic_cast<IBaseFigure*>(_FilledFigure)) != nullptr) {
    //        (dynamic_cast<IBaseFigure*>(_FilledFigure))->UnitsConvert(in_units, out_units);
    //    }
}
...
void Constructive::Keepout_Сonstructive::Shift(float x, float y) {
    //    if ((dynamic_cast<IBaseFigure*>(_FigureContPolyline)) != nullptr) {
    //        (dynamic_cast<IBaseFigure*>(_FigureContPolyline))->Shift(x, y);
    //    }
}

void Constructive::Keepout_Сonstructive::UnitsConvert(dist_ in_units, dist_ out_units) {
    //    if ((dynamic_cast<IBaseFigure*>(_FigureContPolyline)) != nullptr) {
    //        (dynamic_cast<IBaseFigure*>(_FigureContPolyline))->UnitsConvert(in_units, out_units);
    //    }
}
