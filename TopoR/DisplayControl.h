...
struct DisplayControl {
    ...
    struct Units_DisplayControl {
        // Настройка отображения: единицы измерения.
        [[= XML::Attr("preference")]] preference preference{};
    };
    ...
    struct Grid {
        ...
        [[= XML::Attr("gridKind")]] gridKind gridKind{};
        ...
        // Настройка отображения сетки: шаг сетки.
        [[= XML::Elem("GridSpace")]] GridSpace GridSpace;
    };
    ...
    struct LayerOptions {
        ...
        // Настройка отображения: цветовые настройки слоя.
        [[= XML::Elem("Colors")]] Colors_LayerOptions Colors;
        // Настройка отображения слоя: настройки видимости.
        [[= XML::Elem("Show")]] Show_LayerOptions Show;
    };
    ...
    struct ColorNets {
        ...
        struct SetColor {
            ...
            // public Object Refs;
            [[= XML::Elem]] std::variant<NetRef, NetGroupRef, AllNets, SignalRef, DiffSignalRef, SignalGroupRef> Refs;
        };
        ...
        [[= XML::Elem("SetColor")]] std::vector<SetColor> SetColors;
    ...
    struct FilterNetlines {
        ...
        [[= XML::Elem]] std::vector<std::variant<NetRef, NetGroupRef, AllNets, SignalRef, DiffSignalRef, SignalGroupRef>> Refs;
        bool ShouldSerialize_Refs();
    };
    // Версия раздела.
    [[= XML::Attr]] std::string version;
    // Настройка отображения: параметры текущего вида.
    [[= XML::Elem("View")]] View View;
    // Устанавливает активный слой.
    [[= XML::Elem("ActiveLayer")]] ActiveLayer ActiveLayer;
    // Настройка отображения: единицы измерения.
    [[= XML::Elem("Units")]] Units_DisplayControl Units;
    // Настройка отображения: общие цветовые настройки.
    [[= XML::Elem("Colors")]] Colors_DisplayControl Colors;
    //  Настройка отображения: настройки видимости объектов.
    [[= XML::Elem("Show")]] Show_DisplayControl Show;
    //  Настройки сетки.
    [[= XML::Elem("Grid")]] Grid Grid;
    ...
    // Отображение цепей особым цветом.
    [[= XML::Elem("ColorNets")]] ColorNets ColorNets;
    // Фильтр отображения связей.
    [[= XML::Elem("FilterNetlines")]] FilterNetlines FilterNetlines;
    /**************************************************************************
