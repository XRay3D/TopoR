...
struct Settings {
    ...
    struct Autoroute {
        ...
        [[= XML::AttrF]] Bool directConnectSMD{};
        ...
        [[= XML::AttrF]] Bool dontStretchWireToPolypin{};
    ...
    struct Autoproc {
        ...
        [[= XML::AttrF]] refine refine{};
        // Настройка автоматической подвижки.
        [[= XML::AttrF]] automove automove{};
    };
    ...
    struct Labels {
        ...
        [[= XML::AttrF]] Bool bottomHorzRotate{};
        ...
        [[= XML::AttrF]] Bool bottomVertRotate{};
