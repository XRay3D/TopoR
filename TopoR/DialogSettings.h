...
int fractNums;
    ...
    struct BOMSettings {
        // Имя выходного файла (ВОМ, DXF).
        [[= Xml::Attr(NoOpt)]] QString outFile;
