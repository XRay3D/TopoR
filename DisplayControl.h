...
namespace TopoR_PCB_Classes
{
	...
	/// </summary>
	class DisplayControl : public std::enable_shared_from_this<DisplayControl>
	{
		/// <summary>
...
//ORIGINAL LINE: [XmlAttribute("scrollVert", DataType = "float")] public float _scrollVert;
		...
		/// </summary>
	public:
		class ActiveLayer : public std::enable_shared_from_this<ActiveLayer>
		{
...
//ORIGINAL LINE: [XmlAttribute("name")] public string _name;
		...
		/// </summary>
	public:
		class Units_DisplayControl : public std::enable_shared_from_this<Units_DisplayControl>
		{
			/// <summary>
			/// Настройка отображения: единицы измерения.
			/// </summary>
...
//ORIGINAL LINE: [XmlAttribute("preference")] public preference _preference;
		...
		/// </summary>
	public:
		class Colors_DisplayControl : public std::enable_shared_from_this<Colors_DisplayControl>
		{
			/// <summary>
...
//ORIGINAL LINE: [XmlAttribute("trimmed")] public string _trimmed;
		...
		/// </summary>
	public:
		class Show_DisplayControl : public std::enable_shared_from_this<Show_DisplayControl>
		{
			/// <summary>
...
//ORIGINAL LINE: [XmlIgnore] public bool _showSerpentAreaSpecified
	...
	public:
		class Grid : public std::enable_shared_from_this<Grid>
		{
			...
			/// </summary>
		public:
			class GridSpace : public std::enable_shared_from_this<GridSpace>
			{
				/// <summary>
...
//ORIGINAL LINE: [XmlElement("GridSpace")] public GridSpace _GridSpace;
			std::shared_ptr<GridSpace> _GridSpace;
		};
		...
		/// </summary>
	public:
		class LayerOptions : public std::enable_shared_from_this<LayerOptions>
		{
			/// <summary>
			/// Настройка отображения: цветовые настройки слоя.
			/// </summary>
		public:
			class Colors_LayerOptions : public std::enable_shared_from_this<Colors_LayerOptions>
			{
				/// <summary>
...
//ORIGINAL LINE: [XmlAttribute("fix")] public string _fix;
			...
			/// </summary>
		public:
			class Show_LayerOptions : public std::enable_shared_from_this<Show_LayerOptions>
			{
				/// <summary>
				/// Флаг видимости.
				/// </summary>
...
//ORIGINAL LINE: [XmlElement("Colors")] public Colors_LayerOptions _Colors;
			std::shared_ptr<Colors_LayerOptions> _Colors;
...
//ORIGINAL LINE: [XmlElement("Show")] public Show_LayerOptions _Show;
			std::shared_ptr<Show_LayerOptions> _Show;
		};
		...
		/// </summary>
	public:
		class ColorNets : public std::enable_shared_from_this<ColorNets>
		{
			/// <summary>
			/// Отображение цепей особым цветом: установить цвет для цепи / сигнала / группы цепей / группы сигналов.
			/// </summary>
		public:
			class SetColor : public std::enable_shared_from_this<SetColor>
			{
				/// <summary>
...
//ORIGINAL LINE: [XmlElement("SetColor")] public List<SetColor> _SetColors;
			std::vector<std::shared_ptr<SetColor>> _SetColors;
		...
		/// </summary>
	public:
		class FilterNetlines : public std::enable_shared_from_this<FilterNetlines>
		{
			/// <summary>
			/// Флаг применения правила.
			/// </summary>
...
//ORIGINAL LINE: [XmlElement("ActiveLayer")] public ActiveLayer _ActiveLayer;
		std::shared_ptr<ActiveLayer> _ActiveLayer;
...
//ORIGINAL LINE: [XmlElement("Units")] public Units_DisplayControl _Units;
		std::shared_ptr<Units_DisplayControl> _Units;
...
//ORIGINAL LINE: [XmlElement("Colors")] public Colors_DisplayControl _Colors;
		std::shared_ptr<Colors_DisplayControl> _Colors;
...
//ORIGINAL LINE: [XmlElement("Show")] public Show_DisplayControl _Show;
		std::shared_ptr<Show_DisplayControl> _Show;
...
//ORIGINAL LINE: [XmlArray("LayersVisualOptions")][XmlArrayItem("LayerOptions")] public List<LayerOptions> _LayersVisualOptions;
		std::vector<std::shared_ptr<LayerOptions>> _LayersVisualOptions;
...
//ORIGINAL LINE: [XmlElement("ColorNets")] public ColorNets _ColorNets;
		std::shared_ptr<ColorNets> _ColorNets;
...
//ORIGINAL LINE: [XmlElement("FilterNetlines")] public FilterNetlines _FilterNetlines;
		std::shared_ptr<FilterNetlines> _FilterNetlines;
