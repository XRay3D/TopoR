...
namespace TopoR_PCB_Classes
{
	...
	{
		return (_ExportFiles.empty() ? nullptr : _ExportFiles.size()) > 0;
	}
	...
	{
		return (_ExportLayers.empty() ? nullptr : _ExportLayers.size()) > 0;
	}
	...
	{
		return (_AttributeRefs.empty() ? nullptr : _AttributeRefs.size()) > 0;
	}
